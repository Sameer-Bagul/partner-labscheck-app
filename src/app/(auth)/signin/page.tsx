...
export default function SignInPage() {
  ...
  const { mutate: login, isPending } = useLogin(redirectUrl);
  
  const handleLogin = async (data: FormSignInData) => {
    login(data);
  };
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      console.error('SignInPage: Google login error:', error);
    }
  };

  return (
    <div className='relative w-full gradient-bg-primary section-spacing'>
      {/* Animated Background Blobs - Fixed positioning to prevent scroll issues */}
          ...
          <div className='grid lg:grid-cols-2 gap-0 bg-white rounded-3xl shadow-2xl overflow-hidden border border-purple-100/50 backdrop-blur-xl'>
            ...
            >
              ...
              <div className='absolute inset-0'>
                ...
                />
                {/* Multi-layer gradient overlay - darker and more vibrant */}
              ...
              <div className='relative z-10 space-y-6 text-white'>
                ...
                >
                  Sign in to manage your laboratory, bookings, and grow your business with LabsCheck Partner Portal.
                </motion.p>
                ...
                <div className='space-y-4 pt-4'>
                  {[
                    ...
                    { icon: Zap, text: 'Manage bookings & tests' },
                    { icon: Sparkles, text: 'Analytics & insights' },
                  ].map((feature, idx) => (
                    <motion.div
                      key={idx}
            ...
            >
              ...
              <div className='relative z-10 w-full max-w-md mx-auto space-y-8'>
                ...
                <motion.div
                  ...
                  transition={{ delay: 0.5 }}
                >
                  <SignInForm onLogin={handleLogin} isLoading={isPending} />
                </motion.div>
